...
# set path
data_path = "./test_frame/"
action_name_path = './actions.pkl'
...
df.to_pickle("./prediction.pkl")  # save pandas dataframe

# save as txt
tx = pd.DataFrame(data={'filename': os.path.splitext(fnames)[0], 'y_pred': cat2labels(le, all_y_pred)})
tx.to_csv('prediction.txt', sep=' ', index=False, header=False, quoting=csv.QUOTE_NONE, escapechar=' ')
